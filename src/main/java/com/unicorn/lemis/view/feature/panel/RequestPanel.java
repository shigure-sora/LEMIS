...
public class RequestPanel extends JPanel {
    ...
    public RequestPanel() throws SQLException {
        ...
        addParts();
        head = new String[]{"申请编号", "设备名称", "设备ID", "类型", "问题描述", "申请人", "所在实验室","申请状态"};
    ...
    private JPanel getDataPanel() {
        ...
        JLabel labelNew = new JLabel("申请列表");
        ...
        dataTable = new JTable(tableDatas, new String[]{"申请编号", "设备名称", "设备ID", "类型", "问题描述", "申请人", "所在实验室","申请状态"});
    ...
    private void addListener() {
        ...
        buttonEditTechnician.addActionListener(e -> {
            ...
            dataTable.addMouseListener(new MouseAdapter(){
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    greqman = (String) dataTable.getValueAt(i, 5);
            ...
            maintain.setReq_repair_man(greqman);
            ...
            JOptionPane.showMessageDialog(jFrame,"发送有概率失败，请刷新后查看状态(一般提交两次)");
            try {
                ...
                check.deleteNull();
                reload();
                LOGGER.info("Status update to Pending");
        ...
        buttonDeleteTechnician.addActionListener(e -> {
            ...
            try {
                UIManager.put("OptionPane.buttonFont", new FontUIResource(new Font("Microsoft YaHei UI", 0, 13)));
                UIManager.put("OptionPane.messageFont", new FontUIResource(new Font("Microsoft YaHei UI", 0, 13)));
                JOptionPane.showMessageDialog(jFrame,"删除有概率失败，请刷新后查看是否存在(一般取消两次)");
        ...
        buttonFreshTechnician.addActionListener(e -> {
            try {
                AdministratorFrame.requestPanel.reload();
