...
public class TechnicianEquipmentManagePanel extends JPanel {
    ...
    public TechnicianEquipmentManagePanel() throws Exception {
        super();
    ...
    public Object[][] initialize() throws Exception {
        ...
        java.util.List<LEMIS_Equip> list = equipDataAccessObject.queryEquip(equip);
    ...
    private void addListener() {
        ...
        buttonFreshEquip.addActionListener(e -> {
            try {
                TechnicianFrame.equipmentManagePanel.reload();
        ...
        buttonQueryEquip.addActionListener(e -> {
            try {
                ...
                TechnicianFrame.equipmentManagePanel.queryProblem();
